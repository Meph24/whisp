...
public:
	...
	virtual void draw(const SimClock::time_point& t,Frustum * viewFrustum,IWorld& iw,DrawServiceProvider * dsp);//when held by player: must draw GUI and/or the physical item
